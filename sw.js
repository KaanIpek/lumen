...
const CACHE = 'lumen-260805040630';
const ASSETS = [
  './',
  './index.html',
  './privacy.html',
  './manifest.json?v=260805040630',
  './css/style.css?v=260805040630',
  './js/audio.js?v=260805040630',
  './js/game.js?v=260805040630',
  './js/i18n.js?v=260805040630',
  './js/cosmetics.js?v=260805040630',
  './js/modes.js?v=260805040630',
  './js/missions.js?v=260805040630',
  './js/analytics.js?v=260805040630',
  './js/leaderboard.js?v=260805040630',
  './js/iap.js?v=260805040630',
  './js/voice.js?v=260805040630',
  './js/cheats.js?v=260805040630',
  './js/input.js?v=260805040630',
  './js/progression.js?v=260805040630',
  './js/scores.js?v=260805040630',
  './js/save.js?v=260805040630',
  './js/steam.js?v=260805040630',
  './js/native.js?v=260805040630',
  './js/poll.js?v=260805040630',
  './js/ui.js?v=260805040630',
  './js/main.js?v=260805040630',
  './assets/favicon.png',
  './assets/icon-192.png',
  './assets/icon-96.png',
