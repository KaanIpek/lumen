...
const CACHE = 'lumen-260806170837';
const ASSETS = [
  './',
  './index.html',
  './privacy.html',
  './manifest.json?v=260806170837',
  './css/style.css?v=260806170837',
  './js/audio.js?v=260806170837',
  './js/game.js?v=260806170837',
  './js/i18n.js?v=260806170837',
  './js/cosmetics.js?v=260806170837',
  './js/modes.js?v=260806170837',
  './js/missions.js?v=260806170837',
  './js/analytics.js?v=260806170837',
  './js/leaderboard.js?v=260806170837',
  './js/iap.js?v=260806170837',
  './js/voice.js?v=260806170837',
  './js/cheats.js?v=260806170837',
  './js/input.js?v=260806170837',
  './js/progression.js?v=260806170837',
  './js/scores.js?v=260806170837',
  './js/save.js?v=260806170837',
  './js/steam.js?v=260806170837',
  './js/native.js?v=260806170837',
  './js/poll.js?v=260806170837',
  './js/ui.js?v=260806170837',
  './js/main.js?v=260806170837',
  './assets/favicon.png',
  './assets/icon-192.png',
  './assets/icon-96.png',
