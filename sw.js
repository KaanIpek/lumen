...
const CACHE = 'lumen-260805011447';
const ASSETS = [
  './',
  './index.html',
  './privacy.html',
  './manifest.json?v=260805011447',
  './css/style.css?v=260805011447',
  './js/audio.js?v=260805011447',
  './js/game.js?v=260805011447',
  './js/i18n.js?v=260805011447',
  './js/cosmetics.js?v=260805011447',
  './js/modes.js?v=260805011447',
  './js/missions.js?v=260805011447',
  './js/analytics.js?v=260805011447',
  './js/leaderboard.js?v=260805011447',
  './js/iap.js?v=260805011447',
  './js/voice.js?v=260805011447',
  './js/cheats.js?v=260805011447',
  './js/input.js?v=260805011447',
  './js/progression.js?v=260805011447',
  './js/scores.js?v=260805011447',
  './js/save.js?v=260805011447',
  './js/steam.js?v=260805011447',
  './js/native.js?v=260805011447',
  './js/poll.js?v=260805011447',
  './js/ui.js?v=260805011447',
  './js/main.js?v=260805011447',
  './assets/favicon.png',
  './assets/icon-192.png',
  './assets/icon-96.png',
