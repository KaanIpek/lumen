...
const CACHE = 'lumen-260806233525';
const ASSETS = [
  './',
  './index.html',
  './privacy.html',
  './manifest.json?v=260806233525',
  './css/style.css?v=260806233525',
  './js/audio.js?v=260806233525',
  './js/game.js?v=260806233525',
  './js/i18n.js?v=260806233525',
  './js/cosmetics.js?v=260806233525',
  './js/modes.js?v=260806233525',
  './js/missions.js?v=260806233525',
  './js/analytics.js?v=260806233525',
  './js/leaderboard.js?v=260806233525',
  './js/iap.js?v=260806233525',
  './js/voice.js?v=260806233525',
  './js/cheats.js?v=260806233525',
  './js/input.js?v=260806233525',
  './js/progression.js?v=260806233525',
  './js/scores.js?v=260806233525',
  './js/save.js?v=260806233525',
  './js/steam.js?v=260806233525',
  './js/native.js?v=260806233525',
  './js/poll.js?v=260806233525',
  './js/ui.js?v=260806233525',
  './js/main.js?v=260806233525',
  './assets/favicon.png',
  './assets/icon-192.png',
  './assets/icon-96.png',
